...
app.get('/', (req, res) => {
  ...
  res.json({ message: 'API Pastoral Online ✝️', status: 'Running' });
});
...
app.post('/api/membros/check-login', async (req, res) => {
  console.log('👉 Check Login:', req.body.login);
  let client;
  try {
    ...
    if (result.rows.length > 0) {
      console.log('   ✅ Usuário encontrado:', result.rows[0].nome_completo);
...
app.post('/api/membros', async (req, res) => {
  ...
  try {
    ...
    console.log('   ✅ Cadastro realizado, ID:', result.rows[0].id);
