...
CREATE TABLE IF NOT EXISTS eventos (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  titulo TEXT DEFAULT 'Missa dos Idosos',
  descricao TEXT,
...
`;
  ...
  const nodeCode = `
// server.js - Versão 11 (Com Fotos e Novos Campos)
            ...
            {activeTab === 'guide' && (
                <div className="space-y-8 text-sm text-slate-300">
                    ...
                    <div className="bg-red-900/10 border border-red-500/20 p-4 rounded-lg">
                        ...
                        <p className="mb-2">Para habilitar o módulo "Missa dos Idosos", você precisa rodar os scripts SQL e atualizar o Node.js.</p>
